...
<div class="main-content section bg-primary text-dark section-lg {{ auth()->check() && auth()->user()->role === 0 ? 'with-sidebar' : 'no-sidebar' }}">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <form  action="{{ route('hourb.store')}}" method="POST">
                @csrf
                <div class="card bg-primary shadow-soft border-light text-center py-4">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="double" name="current"  class="form-control" id="exampleInputPassword" aria-describedby="passwordHelp" placeholder="current" required autofocus>
                        </div>

                        <div class="form-group mb-4">
                            <label for="exampleInputPassword"> Max</label>
                            <input type="number" name=" max"  class="form-control" id="exampleInputPassword" aria-describedby="passwordHelp" placeholder="max" required autofocus>
                        </div>
